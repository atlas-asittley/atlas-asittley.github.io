...
export function renderBuildPanel() {
  ...
  var available = Object.keys(state.buildingTypes).filter(function (k) {
    ...
    var order = { road: 0, housing: 1, service: 2, extractor: 3, processor: 3, tax: 4 };
  ...
  available.forEach(function (key) {
    ...
    if (bt.category === 'road') {
      ...
      desc = 'Shanty \u2192 Hut \u2192 Cottage \u2192 Townhouse \u2192 Villa \u2192 Manor Estate. Workers: 2\u201334 as conditions improve. Tier 1+ needs a well within 4 tiles.';
      ...
      desc = 'Lets housing within 4 tiles upgrade past tier 0. No workers, no production.';
