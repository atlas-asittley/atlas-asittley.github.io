...
var STAT_INFO = {
  workers: {
    icon: '👷',
    title: 'Workers',
    what: 'Format is <b>used / capacity</b>. Used = workers your active buildings need this tick. Capacity = workers your housing supplies (population × housing tier + tavern bonus).',
    why: 'If used &gt; capacity you have a labor shortage and the lowest-priority buildings sit unstaffed — grayed out, producing nothing. Extractors want 10 workers each, processors 5–10, services 5–10, police 5–15.',
    how: 'Build more housing and meet the prereqs to evolve it past Shanty (well, food, road, school, temple, …). Each tier holds more workers. Build a <b>Tavern</b> for +10 worker capacity while staffed. Don\'t over-build production until housing can keep up.'
  },
  chunks: {
    icon: '🗺',
    title: 'Chunks',
  ...
  happiness: {
    icon: '🙂',
    title: 'Happiness',
    what: 'Rated <b>0–100</b>. ☹ unhappy (under 30) / 😐 mediocre (30–49) / 🙂 content (50–69) / 😊 thriving (70+). Computed each tick from service coverage + housing tier + food variety + staffing − tax pressure − crime.',
    why: 'Below 50, citizens slowly <b>emigrate</b> — your population shrinks tick by tick. At 50+ population fills to housing capacity instantly when you build new houses, but there\'s no extra immigration boost above that. Happy cities grow; unhappy cities bleed citizens.',
    how: 'Build the <b>five service buildings</b> (well, tavern, bathhouse, school, temple) — each covers a small radius. Stock <b>more food types</b> in inventory (variety bonus). Don\'t over-tax — each Tax Office adds pressure. <b>Reduce crime</b> with police buildings (-floor(crime/5) drag on happiness).'
  },
  crime: {
    icon: '🚨',
    title: 'Crime',
    what: 'Rated <b>0–100</b>, lower is better. Generated by active housing <b>not</b> covered by a staffed police building + size pressure (more housing = more crime potential) + each Tavern adds a few points (drinking attracts trouble).',
    why: 'Crime ≥ 50 starts dragging happiness down: <b>-floor(crime/5)</b> per tick. At crime = 80 that\'s -16 happiness — enough to push you into the emigration zone even with full services.',
    how: 'Build police: <b>Watch House</b> (radius 4), <b>Police Station</b> (radius 6, gated at Townhouse), <b>Constabulary</b> (radius 8, gated at Manor). Make sure they\'re <b>staffed</b> — unstaffed police get no coverage credit even with road access. Police buildings also cost $/min in upkeep.'
  },
  migration: {
    icon: '↕',
    title: 'Migration',
