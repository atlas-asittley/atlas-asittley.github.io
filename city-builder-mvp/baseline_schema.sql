...
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('timber_camp', 'Timber Camp', 1, 'timber', 'extractor', 100, 10, NULL, '0', 'timber', '1', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('stone_quarry', 'Stone Quarry', 1, 'stone', 'extractor', 100, 10, NULL, '0', 'stone', '1', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('clay_pit', 'Clay Pit', 1, 'common', 'extractor', 120, 10, NULL, '0', 'clay', '1.5', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('grain_farm', 'Grain Farm', 1, 'common', 'extractor', 150, 10, NULL, '0', 'grain', '2', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('sawmill', 'Sawmill', 2, 'timber', 'processor', 300, 10, 'timber', '1', 'lumber', '0.5', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('mason_workshop', 'Mason Workshop', 2, 'stone', 'processor', 300, 10, 'stone', '1', 'brick', '0.5', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('mill', 'Mill', 2, 'common', 'processor', 300, 10, 'grain', '2', 'flour', '1', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('pottery_kiln', 'Pottery Kiln', 2, 'common', 'processor', 250, 10, 'clay', '1.5', 'pottery', '0.75', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('bakery', 'Bakery', 3, 'common', 'processor', 400, 10, 'flour', '1', 'bread', '0.5', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('woodcarver', 'Woodcarver', 3, 'timber', 'processor', 450, 10, 'lumber', '0.5', 'furniture', '0.25', true, 0);
INSERT INTO public.building_types (key, name, tier, industry_key, category, build_cost, worker_cost, input_resource_key, input_rate, output_resource_key, output_rate, is_active, workers_provided) VALUES ('sculptor', 'Sculptor', 3, 'stone', 'processor', 450, 10, 'brick', '0.5', 'statuary', '0.25', true, 0);
